        ...
        >
            ...
            <form @submit.prevent="handleSubmit" class="space-y-4">
                ...
                <button
                    ...
                    class="w-full inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 disabled:opacity-50"
                >
                ...
                <p v-if="error" class="mt-2 bg-red-100 text-red-700 px-3 py-2 rounded-md text-sm">
                    {{ error }}
                </p>
            </form>
        </div>

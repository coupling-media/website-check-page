...
<template>
    ...
    >
        <div
            class="bg-card text-card-foreground w-11/12 max-w-2xl p-6 rounded-xl shadow-lg relative max-h-[90vh] overflow-y-auto"
        >
            <!-- Close -->
            <button
                @click="emit('close')"
            ...
            <div class="space-y-6 text-sm leading-relaxed text-left">
                <h1 class="text-2xl font-bold mb-6">Datenschutz&shy;erkl&auml;rung</h1>
                <h2 class="font-semibold mb-2">1. Datenschutz auf einen Blick</h2>
                <h3 class="font-semibold mb-1">Allgemeine Hinweise</h3>
                <p>
                ...
                <h3 class="font-semibold mb-1">Datenerfassung auf dieser Website</h3>
                ...
                <h3 class="font-semibold mb-1">Analyse-Tools und Tools von Dritt&shy;anbietern</h3>
                <p>
                ...
                <h2 class="font-semibold mb-2">2. Hosting</h2>
                <p>Wir hosten die Inhalte unserer Website bei folgendem Anbieter:</p>
                <h3 class="font-semibold mb-1">Hetzner</h3>
                <p>
                ...
                <p>
                    ...
                    Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung die
                ...
                <h3 class="font-semibold mb-1">Datenschutz</h3>
                <p>
                ...
                <h3 class="font-semibold mb-1">Hinweis zur verantwortlichen Stelle</h3>
                <p>
                ...
                <p>
                    Telefon: 05221-342560<br />
                    E-Mail: datenschutz@coupling-media.de
                </p>
                <p>
                ...
                <h3 class="font-semibold mb-1">Speicherdauer</h3>
                <p>
                ...
                <h3 class="font-semibold mb-1">Empf&auml;nger von personenbezogenen Daten</h3>
                <p>
                ...
                <h3 class="font-semibold mb-1">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
                <p>
                ...
                <h3 class="font-semibold mb-1">Auskunft, Berichtigung und L&ouml;schung</h3>
                <p>
                ...
                <h3 class="font-semibold mb-1">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
                <p>
                ...
                <h3 class="font-semibold mb-1">SSL- bzw. TLS-Verschl&uuml;sselung</h3>
                <p>
                ...
                <h2 class="font-semibold mb-2">4. Datenerfassung auf dieser Website</h2>
                ...
                <p>
                    ...
                    dieser Einwilligung (Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG); die
                    Einwilligung ist jederzeit widerrufbar.
                </p>
                <p>
                ...
                <h3 class="font-semibold mb-1">Einwilligung mit Usercentrics</h3>
                <p>
                    ...
                    dokumentieren. Anbieter dieser Technologie ist die Usercentrics GmbH, Sendlinger
                    Stra&szlig;e 7, 80331 M&uuml;nchen, Website:
                ...
                <h3 class="font-semibold mb-1">Einwilligung mit Cookiebot</h3>
                <p>
                    Unsere Website nutzt die Consent-Technologie von Cookiebot, um Ihre Einwilligung
                    zur Speicherung bestimmter Cookies auf Ihrem Endger&auml;t oder zum Einsatz
                    bestimmter Technologien einzuholen und diese datenschutzkonform zu
                    dokumentieren. Anbieter dieser Technologie ist Usercentrics A/S, Havnegade 39,
                    1058 Kopenhagen, D&auml;nemark (im Folgenden &bdquo;Cookiebot&ldquo;).
                </p>
                <p>
                    Wenn Sie unsere Website betreten, wird eine Verbindung zu den Servern von
                    Cookiebot hergestellt, um Ihre Einwilligungen und sonstigen Erkl&auml;rungen zur
                    Cookie-Nutzung einzuholen. Anschlie&szlig;end speichert Cookiebot einen Cookie
                    in Ihrem Browser, um Ihnen die erteilten Einwilligungen bzw. deren Widerruf
                    zuordnen zu k&ouml;nnen. Die so erfassten Daten werden gespeichert, bis Sie uns
                    zur L&ouml;schung auffordern, den Cookiebot-Cookie selbst l&ouml;schen oder der
                    Zweck f&uuml;r die Datenspeicherung entf&auml;llt. Zwingende gesetzliche
                    Aufbewahrungspflichten bleiben unber&uuml;hrt.
                </p>
                <p>
                    Der Einsatz von Cookiebot erfolgt, um die gesetzlich vorgeschriebenen
                    Einwilligungen f&uuml;r den Einsatz von Cookies einzuholen. Rechtsgrundlage
                    hierf&uuml;r ist Art. 6 Abs. 1 lit. c DSGVO.
                </p>

                <h3 class="font-semibold mb-1">Kontaktformular</h3>
                <p>
                ...
                <h3 class="font-semibold mb-1">Anfrage per E-Mail, Telefon oder Telefax</h3>
                <p>
                ...
                <h3 class="font-semibold mb-1">Google Forms</h3>
                <p>
                    Wir haben Google Forms auf dieser Website eingebunden. Anbieter ist die die
                    Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland
                    (nachfolgend Google).
                </p>
                <p>
                    Google Forms erm&ouml;glicht es uns, Online-Formulare zu erstellen um
                    Nachrichten, Anfragen und sonstige Eingaben unserer Websitebesucher strukturiert
                    zu erfassen. Alle von Ihnen get&auml;tigten Eingaben werden auf den Servern von
                    Google verarbeitet. Google Forms speichert ein Cookie in Ihrem Browser, das eine
                    eindeutige ID enth&auml;lt (NID-Cookie). Dieses Cookie speichert verschiedene
                ...
                <p>
                    ...
                    Interesses an einer m&ouml;glichst nutzerfreundlichen Ermittlung Ihres Anliegens
                ...
                <p>
                    Weitere Informationen entnehmen Sie der Datenschutzerkl&auml;rung von Google
                    unter
                ...
                <h2 class="font-semibold mb-2">5. Analyse-Tools und Werbung</h2>
                <h3 class="font-semibold mb-1">Google Tag Manager</h3>
                <p>
                ...
                <p>
                    ...
                    speichert keine Cookies und nimmt keine eigenst&auml;ndigen Analysen vor. Er
                    dient lediglich der Verwaltung und Ausspielung der &uuml;ber ihn eingebundenen
                    Tools. Der Google Tag Manager erfasst jedoch Ihre IP-Adresse, die auch an das
                    Mutterunternehmen von Google in die Vereinigten Staaten &uuml;bertragen werden
                    kann.
                </p>
                <p>
                    Der Einsatz des Google Tag Managers erfolgt auf Grundlage von Art. 6 Abs. 1 lit.
                    f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an einer schnellen
                    und unkomplizierten Einbindung und Verwaltung verschiedener Tools auf seiner
                    ...
                    und &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies
                ...
                <p>
                    ...
                    ist die Google Ireland Limited (&bdquo;Google&ldquo;), Gordon House, Barrow
                    Street, Dublin 4, Irland.
                </p>
                <p>
                    Google Analytics erm&ouml;glicht es dem Websitebetreiber, das Verhalten der
                    Websitebesucher zu analysieren. Hierbei erh&auml;lt der Websitebetreiber
                ...
                <p>
                    Des Weiteren k&ouml;nnen wir mit Google Analytics u.&nbsp;a. Ihre Maus- und
                    Scrollbewegungen und Klicks aufzeichnen. Ferner verwendet Google Analytics
                    verschiedene Modellierungsans&auml;tze, um die erfassten Datens&auml;tze zu
                    erg&auml;nzen und setzt Machine-Learning-Technologien bei der Datenanalyse ein.
                </p>
                <p>
                ...
                <p>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        >https://business.safety.google/adscontrollerterms/sccs/</a
                    >.
                </p>
                <p>
                    Das Unternehmen verf&uuml;gt &uuml;ber eine Zertifizierung nach dem &bdquo;EU-US
                ...
                <p>
                    ...
                    IP-Adresse von Google innerhalb von Mitgliedstaaten der Europ&auml;ischen Union
                    oder in anderen Vertragsstaaten des Abkommens &uuml;ber den Europ&auml;ischen
                    Wirtschaftsraum vor der &Uuml;bermittlung in die USA gek&uuml;rzt. Nur in
                    Ausnahmef&auml;llen wird die volle IP-Adresse an einen Server von Google in den
                    USA &uuml;bertragen und dort gek&uuml;rzt. Im Auftrag des Betreibers dieser
                    Website wird Google diese Informationen benutzen, um Ihre Nutzung der Website
                    auszuwerten, um Reports &uuml;ber die Websiteaktivit&auml;ten zusammenzustellen
                    und um weitere mit der Websitenutzung und der Internetnutzung verbundene
                    Dienstleistungen gegen&uuml;ber dem Websitebetreiber zu erbringen. Die im Rahmen
                    von Google Analytics von Ihrem Browser &uuml;bermittelte IP-Adresse wird nicht
                    mit anderen Daten von Google zusammengef&uuml;hrt.
                </p>
                <h4>Browser Plugin</h4>
                <p>
                    Sie k&ouml;nnen die Erfassung und Verarbeitung Ihrer Daten durch Google
                ...
                <p>
                    ...
                    demografische Daten (Besucherdaten). Diese Daten k&ouml;nnen mit Hilfe von
                    Google-Signal f&uuml;r personalisierte Werbung verwendet werden. Wenn Sie
                    &uuml;ber ein Google-Konto verf&uuml;gen, werden die Besucherdaten von
                    Google-Signal mit Ihrem Google-Konto verkn&uuml;pft und f&uuml;r personalisierte
                    Werbebotschaften verwendet. Die Daten werden au&szlig;erdem f&uuml;r die
                    Erstellung anonymisierter Statistiken zum Nutzerverhalten unserer User
                    verwendet.
                </p>
                <h4>Auftragsverarbeitung</h4>
                <p>
                    Wir haben mit Google einen Vertrag zur Auftragsverarbeitung abgeschlossen und
                    setzen die strengen Vorgaben der deutschen Datenschutzbeh&ouml;rden bei der
                    Nutzung von Google Analytics vollst&auml;ndig um.
                </p>
                <h3 class="font-semibold mb-1">Microsoft Advertising</h3>
                <p>
                    Der Websitebetreiber verwendet Microsoft Advertising. Microsoft Advertising ist
                    ein Online-Werbeprogramm der Microsoft Corporation, One Microsoft Way, Redmond,
                    WA 98052-6399, USA.
                </p>
                <p>
                    Microsoft Advertising erm&ouml;glicht es uns Werbeanzeigen in der
                    Bing-Suchmaschine oder auf Drittwebseiten auszuspielen, wenn der Nutzer
                    bestimmte Suchbegriffe bei Bing eingibt (Keyword-Targeting). Ferner k&ouml;nnen
                    zielgerichtete Werbeanzeigen anhand der bei Microsoft vorhandenen Nutzerdaten
                    (z.&nbsp;B. Standortdaten und Interessen) ausgespielt werden
                    (Zielgruppen-Targeting). Wir als Websitebetreiber k&ouml;nnen diese Daten
                    quantitativ auswerten, indem wir beispielsweise analysieren, welche Suchbegriffe
                    zur Ausspielung unserer Werbeanzeigen gef&uuml;hrt haben und wie viele Anzeigen
                    zu entsprechenden Klicks gef&uuml;hrt haben.
                </p>
                <p>
                    Wir nutzen auf dieser Seite die universelle Ereignisnachverfolgung (UET) von
                    Microsoft Advertising. Hierbei werden pseudonymisierte Daten erfasst, um
                    nachzuverfolgen, welche Aktionen Sie auf unseren Webseiten durchf&uuml;hren,
                    nachdem Sie auf eine Werbeanzeige bei Microsoft Advertising geklickt haben.
                    Hierbei erfasst UET Ihre IP-Adresse (anonymisiert), Ger&auml;tekennungen,
                    Informationen &uuml;ber Ger&auml;te- und Browsereinstellungen, Microsoft Click
                    ID (wird in Cookie gespeichert), Verweildauer auf der Website, welche Bereiche
                    der Website abgerufen wurden, &uuml;ber welche Anzeige Sie auf die Website
                    gelangt sind und geklickte geklicktes Keyword.
                </p>
                <p>
                    Die Nutzung dieses Dienstes erfolgt auf Grundlage Ihrer Einwilligung nach Art. 6
                    Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit
                ...
                <p>
                    ...
                    EU-Kommission gest&uuml;tzt. Details finden Sie hier:
                    <a
                        href="https://learn.microsoft.com/de-de/compliance/regulatory/offering-eu-model-clauses"
                        target="_blank"
                        rel="noopener noreferrer"
                        >https://learn.microsoft.com/de-de/compliance/regulatory/offering-eu-model-clauses</a
                    >.
                </p>
                <p>
                    Das Unternehmen verf&uuml;gt &uuml;ber eine Zertifizierung nach dem &bdquo;EU-US
                    ...
                    Anbieter unter folgendem Link:
                    <a
                        href="https://www.dataprivacyframework.gov/participant/6474"
                        target="_blank"
                        rel="noopener noreferrer"
                        >https://www.dataprivacyframework.gov/participant/6474</a
                    >.
                </p>
                <h3 class="font-semibold mb-1">Matomo</h3>
                <p>Diese Website benutzt den Open Source Webanalysedienst Matomo.</p>
                <p>
                    Mit Hilfe von Matomo sind wir in der Lage Daten &uuml;ber die Nutzung unserer
                    Website durch die Websitebesucher zu erfassen und zu analysieren. Hierdurch
                    k&ouml;nnen wir u.&nbsp;a. herausfinden, wann welche Seitenaufrufe get&auml;tigt
                    wurden und aus welcher Region sie kommen. Au&szlig;erdem erfassen wir
                    verschiedene Logdateien (z.&nbsp;B. IP-Adresse, Referrer, verwendete Browser und
                    Betriebssysteme) und k&ouml;nnen messen, ob unsere Websitebesucher bestimmte
                ...
                <h3 class="font-semibold mb-1">Google Ads</h3>
                <p>
                    Der Websitebetreiber verwendet Google Ads. Google Ads ist ein
                    Online-Werbeprogramm der Google Ireland Limited (&bdquo;Google&ldquo;), Gordon
                    House, Barrow Street, Dublin 4, Irland.
                </p>
                <p>
                    Google Ads erm&ouml;glicht es uns Werbeanzeigen in der Google-Suchmaschine oder
                    auf Drittwebseiten auszuspielen, wenn der Nutzer bestimmte Suchbegriffe bei
                    Google eingibt (Keyword-Targeting). Ferner k&ouml;nnen zielgerichtete
                    Werbeanzeigen anhand der bei Google vorhandenen Nutzerdaten (z.&nbsp;B.
                    Standortdaten und Interessen) ausgespielt werden (Zielgruppen-Targeting). Wir
                    als Websitebetreiber k&ouml;nnen diese Daten quantitativ auswerten, indem wir
                    beispielsweise analysieren, welche Suchbegriffe zur Ausspielung unserer
                    Werbeanzeigen gef&uuml;hrt haben und wie viele Anzeigen zu entsprechenden Klicks
                    gef&uuml;hrt haben.
                </p>
                <p>
                    Die Nutzung dieses Dienstes erfolgt auf Grundlage Ihrer Einwilligung nach Art. 6
                ...
                <p>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        >https://business.safety.google/controllerterms/</a
                    >.
                </p>
                <p>
                    Das Unternehmen verf&uuml;gt &uuml;ber eine Zertifizierung nach dem &bdquo;EU-US
                ...
                <h3 class="font-semibold mb-1">Google Conversion-Tracking</h3>
                <p>
                ...
                <p>
                    Mit Hilfe von Google-Conversion-Tracking k&ouml;nnen Google und wir erkennen, ob
                    der Nutzer bestimmte Aktionen durchgef&uuml;hrt hat. So k&ouml;nnen wir
                    beispielsweise auswerten, welche Buttons auf unserer Website wie h&auml;ufig
                    geklickt und welche Produkte besonders h&auml;ufig angesehen oder gekauft
                    wurden. Diese Informationen dienen dazu, Conversion-Statistiken zu erstellen.
                    Wir erfahren die Gesamtanzahl der Nutzer, die auf unsere Anzeigen geklickt haben
                    und welche Aktionen sie durchgef&uuml;hrt haben. Wir erhalten keine
                    Informationen, mit denen wir den Nutzer pers&ouml;nlich identifizieren
                    k&ouml;nnen. Google selbst nutzt zur Identifikation Cookies oder vergleichbare
                ...
                <h2 class="font-semibold mb-2">6. Newsletter</h2>
                <h3 class="font-semibold mb-1">Newsletter&shy;daten</h3>
                <p>
                    Wenn Sie den auf der Website angebotenen Newsletter beziehen m&ouml;chten,
                    ben&ouml;tigen wir von Ihnen eine E-Mail-Adresse sowie Informationen, welche uns
                    die &Uuml;berpr&uuml;fung gestatten, dass Sie der Inhaber der angegebenen
                    E-Mail-Adresse und mit dem Empfang des Newsletters einverstanden sind. Weitere
                    Daten werden nicht bzw. nur auf freiwilliger Basis erhoben. F&uuml;r die
                    Abwicklung der Newsletter nutzen wir Newsletterdiensteanbieter, die nachfolgend
                    beschrieben werden.
                </p>
                <h3 class="font-semibold mb-1">CleverReach</h3>
                <p>
                    Diese Website nutzt CleverReach f&uuml;r den Versand von Newslettern. Anbieter
                    ist die CleverReach GmbH &amp; Co. KG, Schafj&uuml;ckenweg 2, 26180 Rastede,
                    Deutschland (nachfolgend &bdquo;CleverReach&ldquo;). CleverReach ist ein Dienst,
                    mit dem der Newsletterversand organisiert und analysiert werden kann. Die von
                    Ihnen zwecks Newsletterbezug eingegebenen Daten (z.&nbsp;B. E-Mail-Adresse)
                    werden auf den Servern von CleverReach in Deutschland bzw. Irland gespeichert.
                </p>
                <p>
                    Unsere mit CleverReach versandten Newsletter erm&ouml;glichen uns die Analyse
                    des Verhaltens der Newsletterempf&auml;nger. Hierbei kann u.&nbsp;a. analysiert
                    werden, wie viele Empf&auml;nger die Newsletternachricht ge&ouml;ffnet haben und
                    wie oft welcher Link im Newsletter angeklickt wurde. Mit Hilfe des sogenannten
                    Conversion-Trackings kann au&szlig;erdem analysiert werden, ob nach Anklicken
                    des Links im Newsletter eine vorab definierte Aktion (z.&nbsp;B. Kauf eines
                    Produkts auf dieser Website) erfolgt ist. Weitere Informationen zur Datenanalyse
                    durch CleverReach-Newsletter erhalten Sie unter:
                    <a
                ...
                <p>
                    ...
                    lit. a DSGVO). Sie k&ouml;nnen diese Einwilligung jederzeit widerrufen, indem
                    Sie den Newsletter abbestellen. Die Rechtm&auml;&szlig;igkeit der bereits
                    erfolgten Datenverarbeitungsvorg&auml;nge bleibt vom Widerruf unber&uuml;hrt.
                </p>
                <p>
                    Wenn Sie keine Analyse durch CleverReach wollen, m&uuml;ssen Sie den Newsletter
                    abbestellen. Hierf&uuml;r stellen wir in jeder Newsletternachricht einen
                ...
                <p>
                    ...
                    aus der Newsletterverteilerliste gel&ouml;scht. Daten, die zu anderen Zwecken
                ...
                <p>
                    ...
                    sofern dies zur Verhinderung k&uuml;nftiger Mailings erforderlich ist. Die Daten
                    aus der Blacklist werden nur f&uuml;r diesen Zweck verwendet und nicht mit
                    anderen Daten zusammengef&uuml;hrt. Dies dient sowohl Ihrem Interesse als auch
                    ...
                    <strong
                        ...
                        berechtigtes Interesse &uuml;berwiegen.</strong
                    >
                </p>
                <p>
                    N&auml;heres entnehmen Sie den Datenschutzbestimmungen von CleverReach unter:
                    <a
                ...
                <h2 class="font-semibold mb-2">7. Plugins und Tools</h2>
                <h3 class="font-semibold mb-1">Google Fonts</h3>
                <p>
                ...
                <p>
                    ...
                    Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung
                ...
                <h2 class="font-semibold mb-2">8. Audio- und Videokonferenzen</h2>
                <h3 class="font-semibold mb-1">Datenverarbeitung</h3>
                <p>
                    F&uuml;r die Kommunikation mit unseren Kunden setzen wir unter anderen
                ...
                <p>
                    ...
                    &bdquo;Kontextinformationen&ldquo; im Zusammenhang mit dem Kommunikationsvorgang
                    (Metadaten).
                </p>
                <p>
                    ...
                    IP-Adressen, MAC-Adressen, Ger&auml;te-IDs, Ger&auml;tetyp, Betriebssystemtyp
                    und -version, Client-Version, Kameratyp, Mikrofon oder Lautsprecher sowie die
                    Art der Verbindung.
                </p>
                <p>
                    ...
                    Tool-Anbieter gespeichert. Zu solchen Inhalten z&auml;hlen insbesondere
                    Cloud-Aufzeichnungen, Chat-/ Sofortnachrichten, Voicemails hochgeladene Fotos
                    und Videos, Dateien, Whiteboards und andere Informationen, die w&auml;hrend der
                    Nutzung des Dienstes geteilt werden.
                </p>
                <p>
                    Bitte beachten Sie, dass wir nicht vollumf&auml;nglich Einfluss auf die
                    Datenverarbeitungsvorg&auml;nge der verwendeten Tools haben. Unsere
                    M&ouml;glichkeiten richten sich ma&szlig;geblich nach der Unternehmenspolitik
                    des jeweiligen Anbieters. Weitere Hinweise zur Datenverarbeitung durch die
                    Konferenztools entnehmen Sie den Datenschutzerkl&auml;rungen der jeweils
                    eingesetzten Tools, die wir unter diesem Text aufgef&uuml;hrt haben.
                </p>
                <h3>Zweck und Rechtsgrundlagen</h3>
                <p>
                    Die Konferenz-Tools werden genutzt, um mit angehenden oder bestehenden
                    Vertragspartnern zu kommunizieren oder bestimmte Leistungen gegen&uuml;ber
                    unseren Kunden anzubieten (Art. 6 Abs. 1 lit. b DSGVO). Des Weiteren dient der
                    ...
                    von Art. 6 Abs. 1 lit. f DSGVO). Soweit eine Einwilligung abgefragt wurde,
                    erfolgt der Einsatz der betreffenden Tools auf Grundlage dieser Einwilligung;
                    die Einwilligung ist jederzeit mit Wirkung f&uuml;r die Zukunft widerrufbar.
                </p>
                <h3>Speicherdauer</h3>
                <p>
                    Die unmittelbar von uns &uuml;ber die Video- und Konferenz-Tools erfassten Daten
                    werden von unseren Systemen gel&ouml;scht, sobald Sie uns zur L&ouml;schung
                    auffordern, Ihre Einwilligung zur Speicherung widerrufen oder der Zweck f&uuml;r
                    die Datenspeicherung entf&auml;llt. Gespeicherte Cookies verbleiben auf Ihrem
                    Endger&auml;t, bis Sie sie l&ouml;schen. Zwingende gesetzliche
                ...
                <p>
                    ...
                    eigenen Zwecken gespeichert werden, haben wir keinen Einfluss. F&uuml;r
                ...
                <p>
                    Wir nutzen Microsoft Teams. Anbieter ist die Microsoft Ireland Operations
                    Limited, One Microsoft Place, South County Business Park, Leopardstown, Dublin
                    18, Irland. Details zur Datenverarbeitung entnehmen Sie der
                    Datenschutzerkl&auml;rung von Microsoft Teams:
                    <a
                ...
                <h2 class="font-semibold mb-2">9. Eigene Dienste</h2>
                <h3 class="font-semibold mb-1">Umgang mit Bewerberdaten</h3>
                <p>
                    Wir bieten Ihnen die M&ouml;glichkeit, sich bei uns zu bewerben (z.&nbsp;B. per
                    E-Mail, postalisch oder via Online-Bewerberformular). Im Folgenden informieren
                    wir Sie &uuml;ber Umfang, Zweck und Verwendung Ihrer im Rahmen des
                    Bewerbungsprozesses erhobenen personenbezogenen Daten. Wir versichern, dass die
                    Erhebung, Verarbeitung und Nutzung Ihrer Daten in &Uuml;bereinstimmung mit
                    geltendem Datenschutzrecht und allen weiteren gesetzlichen Bestimmungen erfolgt
                ...
                <p>
                    ...
                    Bewerbungsgespr&auml;chen etc.), soweit dies zur Entscheidung &uuml;ber die
                    Begr&uuml;ndung eines Besch&auml;ftigungsverh&auml;ltnisses erforderlich ist.
                    Rechtsgrundlage hierf&uuml;r ist &sect; 26 BDSG nach deutschem Recht (Anbahnung
                    eines Besch&auml;ftigungsverh&auml;ltnisses), Art. 6 Abs. 1 lit. b DSGVO
                    (allgemeine Vertragsanbahnung) und &ndash; sofern Sie eine Einwilligung erteilt
                    haben &ndash; Art. 6 Abs. 1 lit. a DSGVO. Die Einwilligung ist jederzeit
                    widerrufbar. Ihre personenbezogenen Daten werden innerhalb unseres Unternehmens
                    ausschlie&szlig;lich an Personen weitergegeben, die an der Bearbeitung Ihrer
                    Bewerbung beteiligt sind.
                </p>
                <p>
                    Sofern die Bewerbung erfolgreich ist, werden die von Ihnen eingereichten Daten
                    auf Grundlage von &sect; 26 BDSG und Art. 6 Abs. 1 lit. b DSGVO zum Zwecke der
                    Durchf&uuml;hrung des Besch&auml;ftigungsverh&auml;ltnisses in unseren
                ...
                <p>
                    ...
                    ablehnen oder Ihre Bewerbung zur&uuml;ckziehen, behalten wir uns das Recht vor,
                    die von Ihnen &uuml;bermittelten Daten auf Grundlage unserer berechtigten
                    Interessen (Art. 6 Abs. 1 lit. f DSGVO) bis zu 6 Monate ab der Beendigung des
                    Bewerbungsverfahrens (Ablehnung oder Zur&uuml;ckziehung der Bewerbung) bei uns
                    aufzubewahren. Anschlie&szlig;end werden die Daten gel&ouml;scht und die
                    ...
                    Daten nach Ablauf der 6-Monatsfrist erforderlich sein werden (z.&nbsp;B.
                    aufgrund eines drohenden oder anh&auml;ngigen Rechtsstreits), findet eine
                    L&ouml;schung erst statt, wenn der Zweck f&uuml;r die weitergehende Aufbewahrung
                    entf&auml;llt.
                </p>
                <p>
                    Eine l&auml;ngere Aufbewahrung kann au&szlig;erdem stattfinden, wenn Sie eine
                    entsprechende Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) erteilt haben oder wenn
                    gesetzliche Aufbewahrungspflichten der L&ouml;schung entgegenstehen.
                </p>
                <h4>Aufnahme in den Bewerber-Pool</h4>
                <p>
                    Sofern wir Ihnen kein Stellenangebot machen, besteht ggf. die M&ouml;glichkeit,
                    Sie in unseren Bewerber-Pool aufzunehmen. Im Falle der Aufnahme werden alle
                    Dokumente und Angaben aus der Bewerbung in den Bewerber-Pool &uuml;bernommen, um
                    Sie im Falle von passenden Vakanzen zu kontaktieren.
                </p>
                <p>
                    Die Aufnahme in den Bewerber-Pool geschieht ausschlie&szlig;lich auf Grundlage
                    Ihrer ausdr&uuml;cklichen Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Die Abgabe
                    der Einwilligung ist freiwillig und steht in keinem Bezug zum laufenden
                    Bewerbungsverfahren.
                    <strong>Der Betroffene kann seine Einwilligung jederzeit widerrufen.</strong> In
                    diesem Falle werden die Daten aus dem Bewerber-Pool unwiderruflich
                    gel&ouml;scht, sofern keine gesetzlichen Aufbewahrungsgr&uuml;nde vorliegen.
                </p>
                <p>
                    Die Daten aus dem Bewerber-Pool werden sp&auml;testens zwei Jahre nach Erteilung
                    der Einwilligung unwiderruflich gel&ouml;scht.
                </p>
            </div>
        </div>
    </div>

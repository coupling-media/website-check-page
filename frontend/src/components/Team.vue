...
const teamList: TeamProps[] = [
    {
        imageUrl: "team/sj-team.jpg",
        firstName: "Stefanie",
        lastName: "Jany",
        positions: ["Geschäftsführung"],
        socialNetworks: [],
    },
    {
        imageUrl: "team/dm-team.jpg",
        firstName: "Daniela",
        lastName: "Michel",
        positions: ["Senior Manager Online Marketing"],
        socialNetworks: [],
    },
    {
        imageUrl: "team/kw-team.jpg",
        firstName: "Kristina",
        lastName: "Wiemann",
        positions: ["Senior Webdeveloper"],
        socialNetworks: [],
    },
    {
        imageUrl: "team/dirk-team.webp",
        firstName: "Dirk",
        lastName: "Markus",
        positions: ["Senior Customer Data Specialist"],
        socialNetworks: [],
    },
    {
        imageUrl: "team/ab-team.webp",
        firstName: "Anne",
        lastName: "Beckhoff",
        positions: ["Automation Specialist"],
        socialNetworks: [],
    },
    {
        imageUrl: "team/au-team.jpg",
        firstName: "Adrian",
        lastName: "Uhe",
        positions: ["B.Sc. in Computer Science | M.Sc. in Computer Science in progress"],
        socialNetworks: [],
    },
];
...
<template>
    <section id="team" class="container lg:w-[75%] py-24 sm:py-32">
        <div class="text-center mb-8">
            ...
            <h2 class="text-3xl md:text-4xl text-center font-bold">Das ist coupling media</h2>
        </div>
